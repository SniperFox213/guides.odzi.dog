	...
	<main in:fade style="font-family: 'Manrope', sans-serif;" class="bg-gray-100 w-full relative">
		...
		<section class="w-full pt-16">
			...
			<div class="w-full text-center mt-16 pt-6 bg-white">
				<!-- heading -->
				<h1 class="text-3xl text-black font-semibold">Тема: «Поведение собаки»</h1>
			
				<!-- Information -->
				<div>
					<h2 class="text-sm text-gray-700">Всего 4 статьи</h2>
				</div>
			</div>
			...
			<div class="bg-white flex flex-wrap relative pt-6">
				<!-- Guides Entry -->
